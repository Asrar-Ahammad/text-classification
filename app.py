...
class MyModelClass:
    ...
    def load_model(self, path='nlp_model.pth'):
        ...
        missing_keys = set(self.model.state_dict().keys()) - \
            set(state_dict.keys())

        if 'bert.embeddings.position_ids' in missing_keys:
            print(
                "Warning: The 'position_ids' parameter is missing in the loaded state_dict. Ignoring it.")
...
arch_model = MyModelClass(
    model_name='bert-base-multilingual-cased', num_labels=2)
